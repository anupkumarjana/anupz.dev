...
export default function ReversedCard(props) {
  return (
    <div className="flex md:flex-row-reverse flex-col gap-10 md:gap-20 my-10 bg-white p-6 rounded-xl shadow-[0_8px_30px_rgb(0,0,0,0.12)]">
